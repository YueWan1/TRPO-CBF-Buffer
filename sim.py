...
parser.add_argument('--kl_constraint', type=float, default=0.01)  #Originally 0.01
...
parser.add_argument('--total_train_step', type=int, default=2.4e5) # default 1.2e6
...
with tf.compat.v1.Session(config=config) as sess:
    ...
    trpo_gae_learner.agent.BufS = []  # Initialize safe buffer
    trpo_gae_learner.agent.BufC = []  # Initialize collision buffer
